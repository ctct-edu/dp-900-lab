...
1. Azure portalで**"ストレージ アカウント"**を検索します。  **[ストレージ センター]** ページで、**[作成]** を選択します。
...
1. **[次へ: 詳細]** を選択し、詳細な構成オプションを表示します。デフォルトの設定を維持して、 **[次へ: ネットワーク]** を選択して、ストレージ アカウントのネットワーク オプションを表示します。こちらもデフォルトのまま次へ進めます。
